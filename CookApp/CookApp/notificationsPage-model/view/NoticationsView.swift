...
class NoticationsView: UITableViewController {
    ...
    // MARK : - Get Nnotifications list from firebase
    func getNotificationsList(){
    /// test notification list
    notificationsList = ["Noti1","Noti2","Noti3","Noti4","Noti5"]
    }
